...
const AreaCreate = ({ onVolver }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setApiError(error.response?.data?.error || 'Error al registrar el área');
        } finally {
            setGuardando(false);
        }
    };
    ...
    return (
        <>
            <div className="d-flex justify-content-between align-items-start mb-4">
                <div>
                    <h5 className="fw-bold mb-1">Nueva Unidad Organizativa</h5>
                    <p className="text-muted small mb-0">Registra una nueva área vinculada a un contratista</p>
                </div>
            ...
            <div className="card border">
                ...
                <div className="card-header bg-light d-flex align-items-center gap-3 py-3">
                    ...
                    <div>
                        <p className="fw-semibold mb-0 small">Crear Nueva Área</p>
                        <p className="text-muted mb-0" style={{ fontSize: 12 }}>Complete la información para registrar el área en el sistema.</p>
                    </div>
                </div>
                        ...
                        <div className="row g-3 p-4">
                            <div className="col-12">
                                ...
                                <input
                                    ...
                                    placeholder="Ej: Ingeniería, Contabilidad, Finanzas..."
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="form-text">Una Unidad Organizativa no puede existir sin un Contratista padre.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-center p-4 bg-light">
                        <button type="submit" className="btn btn-primary px-5" disabled={guardando}>
                            {guardando
                                ...
                                : <><i className="bi bi-floppy me-2" />Registrar Área</>
                            }
                        </button>
                    </div>
