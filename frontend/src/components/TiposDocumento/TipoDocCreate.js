...
const TipoDocCreate = ({ onVolver }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setGuardando(true);
            await axios.post('/api/tipos-doc', formData);
            onVolver();
        } catch (error) {
            setApiError(error.response?.data?.error || 'Error al registrar el tipo de documento');
        } finally {
            setGuardando(false);
        }
    };
    ...
    return (
        <>
            <div className="d-flex justify-content-between align-items-start mb-4">
                <div>
                    <h5 className="fw-bold mb-1">Nuevo Tipo de Documento</h5>
                    <p className="text-muted small mb-0">Registra un nuevo tipo de documento en el sistema</p>
                </div>
            ...
            <div className="card border">
                <div className="card-header bg-light d-flex align-items-center gap-3 py-3">
                    ...
                    <div>
                        <p className="fw-semibold mb-0 small">Crear Nuevo Tipo de Documento</p>
                        <p className="text-muted mb-0" style={{ fontSize: 12 }}>
                            Ejemplos: Carta, Oficio, Memo, Informe, Plano…
                        </p>
                    </div>
                </div>
                        ...
                        <div className="row g-3 p-4">
                            <div className="col-12">
                                ...
                                <input
                                    ...
                                    placeholder="Ej: Carta, Oficio, Memo, Informe…"
